...
# python3 detr_video_inference.py -i source_video/WAM_V_2.mp4 -o out_video/WAM_V_2_out.mp4
# python3 detr_video_inference.py -i source_video/WAM_V_3.mp4 -o out_video/WAM_V_3_out.mp4
# python3 detr_video_inference.py -i source_video/Multi_Boat.mp4 -o out_video/Multi_Boat_out.mp4
...
while(cap.isOpened()):
    ...
    print(f"Processed frame {frame_count} with FPS: {fps:.2f}")
